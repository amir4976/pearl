...
interface MenuDrawerProps {
  setIsShowMenuDrawer: (isOpen: boolean) => void;
}
...
const MenuDrawer: React.FC<MenuDrawerProps> = ({
  ...
  return (
    <div
      ...
      onClick={() => setIsShowMenuDrawer(false)} // بستن هنگام کلیک روی پس‌زمینه
    >
      <div
      ...
      >
        <div className="flex justify-between py-5 ">
          <p>منو</p>
          <button onClick={()=>setIsShowMenuDrawer(false)}><CloseSquare size="32" color="#F3D098"/></button>
        </div>
